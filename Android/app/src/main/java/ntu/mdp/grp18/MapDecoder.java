...
//        Log.d("test", "hexToExploredMap: explored hexString = " + exploredHex);
//        Log.d("test", "hexToExploredMap: explored binString = " + binString);
//        Log.d("test", "hexToExploredMap: explored binString length = " + binString.length());
//
//        int count = -4;
...
//
//        }
//        Log.d("test", "hexToExploredMap: explored binString num of 1 = " + count);
    ...
    private static void hexToObstacleMap(String obstacleHex){
        ...
        int binStringPtr = 0;
//        Log.d("test", "hexToObstacleMap: obstacleHex = " + obstacleHex);
//        Log.d("test", "hexToObstacleMap: obstacle binString = " + binString);
//        Log.d("test", "hexToObstacleMap: obstacle binString length = " + binString.length());
//        Log.d("test", "------------------------------------------------------------------------------------------");
